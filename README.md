...
Official Server: ``http://web.nextage.top:9090/instance.json``
...
```
{"serverAddress":"localhost","serverPort":1234,"token":"Your custom token here", "Source":"http://web.nextage.top:9090/instance.json", "fromSource":"NO"}
```
